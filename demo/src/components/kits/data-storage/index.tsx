// Data-storage kit chassis. PCB / phosphor theme. Owns Bench state so the
// circuit backdrop's pulse animation toggles whenever the user is actively
// moving the bench. Sections live in ./sections/ as SectionLayout composers.
