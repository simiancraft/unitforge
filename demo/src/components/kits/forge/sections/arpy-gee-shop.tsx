...
const COIN = 'coin' as const;
const GOODS = 'goods' as const;
...
// Two units in one dimension; the 10:1 rate lives in gold.toBase.
const COIN  = 'coin'  as const;
const GOODS = 'goods' as const;
